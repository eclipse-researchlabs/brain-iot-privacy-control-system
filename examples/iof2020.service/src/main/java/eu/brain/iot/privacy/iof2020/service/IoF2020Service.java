package eu.brain.iot.privacy.iof2020.service;
...
@Component(immediate=true, service= {SmartBehaviour.class, IoF2020Service.class})
@SmartBehaviourDefinition(consumed= {LocalizationEventDTO.class},filter="", 
                         author="LINKS", name ="IoF2020 Service Behavior", 
                         description="Service for the IoF2020 project")
public class IoF2020Service implements SmartBehaviour<LocalizationEventDTO>{
	...
	public void start(BundleContext context){
		System.out.println("Service: I am the IoF2020 Service");
	...
	public void notify(LocalizationEventDTO event) {
		System.out.println("IoF2020 Service: event received with token: "+event.token);
		...
		try {
			clientMQTT.publish("/brainiot/IOF2020/"+event.deviceId+"/localization",	eventToSend.getBytes(), 0, false);
